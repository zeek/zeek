...
report it privately and allow the Zeek Security Team (ZST) to decide.

Do not open a public issue or pull request, or publish a reproducer or proposed
fix, until the ZST confirms that public development is appropriate. Follow the
reporting website for current transport instructions. If sensitive captures or
large binary artifacts are needed, describe them in the initial report and ask
the ZST how to transfer them.
...
The ZST makes final decisions about classification, severity, disclosure,
