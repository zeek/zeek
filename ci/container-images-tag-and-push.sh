...
ARM64_IMAGE_GIT_SHA=$(docker inspect -f json zeek/zeek-multiarch:arm64 | jq ".[0].Config.Labels.git_commit")
AMD64_IMAGE_GIT_SHA=$(docker inspect -f json zeek/zeek-multiarch:arm64 | jq ".[0].Config.Labels.git_commit")
