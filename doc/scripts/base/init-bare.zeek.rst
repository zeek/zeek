...
###############
============================================================================================================== =============================================================================
:zeek:id:`Cluster::default_table_publish_on_change_max_batch_delay`: :zeek:type:`interval` :zeek:attr:`&redef` Default maximum delay size for the &publish_on_change attribute on tables.
:zeek:id:`Cluster::default_table_publish_on_change_max_batch_size`: :zeek:type:`count` :zeek:attr:`&redef`     Default maximum batch size for the &publish_on_change attribute on tables.
