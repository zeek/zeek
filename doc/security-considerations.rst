...
* When managing a multi-host cluster, ZeekControl uses SSH from the manager to run
  commands and deploy configuration and policy files on the other cluster hosts. The
