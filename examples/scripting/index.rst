...
an online documentation system using Zeexygen.  Whether starting a
...
:zeek:id:`split` is called to break the string into separate pieces.
...
``print`` and  :zeek:id:`fmt` we can ensure that Bro can perform these
