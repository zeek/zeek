...
# These are defined in const.bif and might be of interest:
# redef use_conn_size_analyzer
# redef record_state_history
...
function conn_size_from_analyzer(e: endpoint): string
	{
	return fmt("%d %d", (e?$packets) ? e$packets : 0,
			(e?$ipbytes) ? e$ipbytes : 0);
	}
...
@endif
	...
	if ( record_state_history && c?$history )
