...
export {
	...
	##
	## Returns: A record containing the status of the operation and an
	##          optional error string for failures.
	...
	##
	## Returns: A record containing the status of the operation, an optional
	##          error string for failures, and an optional value for
	##          success. The value returned here will be of the type passed
	##          into :zeek:see:`Storage::open_backend`.
