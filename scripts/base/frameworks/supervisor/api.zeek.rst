...
######
=========================================================== ======================================================================
:zeek:id:`Supervisor::create_request`: :zeek:type:`event`   Send a request to a remote Supervisor process to create a node.
:zeek:id:`Supervisor::create_response`: :zeek:type:`event`  Handle a response from a Supervisor process that received
                                                            :zeek:see:`Supervisor::create_request`.
:zeek:id:`Supervisor::destroy_request`: :zeek:type:`event`  Send a request to a remote Supervisor process to destroy a node.
:zeek:id:`Supervisor::destroy_response`: :zeek:type:`event` Handle a response from a Supervisor process that received
                                                            :zeek:see:`Supervisor::destroy_request`.
:zeek:id:`Supervisor::restart_request`: :zeek:type:`event`  Send a request to a remote Supervisor process to restart a node.
:zeek:id:`Supervisor::restart_response`: :zeek:type:`event` Handle a response from a Supervisor process that received
                                                            :zeek:see:`Supervisor::restart_request`.
:zeek:id:`Supervisor::status_request`: :zeek:type:`event`   Send a request to a remote Supervisor process to retrieve node status.
:zeek:id:`Supervisor::status_response`: :zeek:type:`event`  Handle a response from a Supervisor process that received
                                                            :zeek:see:`Supervisor::status_request`.
:zeek:id:`Supervisor::stop_request`: :zeek:type:`event`     Send a request to a remote Supervisor to stop and shutdown its
                                                            process tree.
=========================================================== ======================================================================
...
Events
######
.. zeek:id:: Supervisor::create_request
...
.. zeek:id:: Supervisor::create_response
...
.. zeek:id:: Supervisor::destroy_request
...
.. zeek:id:: Supervisor::destroy_response
...
.. zeek:id:: Supervisor::restart_request
...
.. zeek:id:: Supervisor::restart_response
...
.. zeek:id:: Supervisor::status_request
...
.. zeek:id:: Supervisor::status_response
...
.. zeek:id:: Supervisor::stop_request
