...
export {
	## The connection tuple factory to use for Zeek's internal flow
	...
	## record to represent additional flow tuple members.
	const factory = ConnTuple::CONNTUPLE_FIVETUPLE &redef;
}
