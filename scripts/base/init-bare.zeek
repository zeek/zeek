...
type l2_hdr: record {
	...
	vlan_pcp: count &optional;	##< Outermost VLAN PCP if any (and Ethernet).
	vlan_dei: bool &optional;	##< Outermost VLAN DEI if any (and Ethernet).
	inner_vlan: count &optional;	##< Innermost VLAN tag if any (and Ethernet).
	inner_vlan_pcp: count &optional;	##< Innermost VLAN PCP if any (and Ethernet).
	inner_vlan_dei: bool &optional;	##< Innermost VLAN DEI if any (and Ethernet).
