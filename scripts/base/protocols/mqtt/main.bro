...
export {
	...
	type PublishInfo: record {
		...
		## NOT LOGGED! Track if the message was acked
		ack:         bool    &default=F;
		## NOT LOGGED! Indicates if the server sent the RECEIVED qos message
		rec:         bool    &default=F;
		## NOT LOGGED! Indicates if the client sent the RELEASE qos message
		rel:         bool    &default=F;
		## NOT LOGGED! Indicates if the server sent the COMPLETE qos message
		comp:        bool    &default=F;
		## NOT LOGGED! Internally used for comparing numeric qos level
