...
export {
       ...
       ##	    itself. Use dhcp_message instead.
       ##
       ...
       ##    associates packets into transport-level flows in the same way as usual.
       ##
       global dhcp_offer: event(c: connection, msg: DHCP::dhcp_msg, mask: addr, router: DHCP::dhcp_router_list, lease: interval, serv_addr: addr, host_name: string) &deprecated;
       ...
       ##    associates packets into transport-level flows in the same way as usual.
       ##
       global dhcp_request: event(c: connection, msg: DHCP::dhcp_msg, req_addr: addr, serv_addr: addr, host_name: string) &deprecated;
       ...
       ##    associates packets into transport-level flows in the same way as usual.
       ##
       global dhcp_decline: event(c: connection, msg: DHCP::dhcp_msg, host_name: string) &deprecated;
       ...
       ##    Use dhcp_message instead.
       ##
       global dhcp_ack: event(c: connection, msg: DHCP::dhcp_msg, mask: addr, router: DHCP::dhcp_router_list, lease: interval, serv_addr: addr, host_name: string) &deprecated;
       ...
       ##    associates packets into transport-level flows in the same way as usual.
       ##
       global dhcp_nak: event(c: connection, msg: DHCP::dhcp_msg, host_name: string) &deprecated;
       ...
       ##    Use dhcp_message instead.
       ##
       global dhcp_release: event(c: connection, msg: DHCP::dhcp_msg, host_name: string) &deprecated;
       ...
       ##    associates packets into transport-level flows in the same way as usual.
       ##
       global dhcp_inform: event(c: connection, msg: DHCP::dhcp_msg, host_name: string) &deprecated;
