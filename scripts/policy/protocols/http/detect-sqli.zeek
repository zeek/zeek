...
## Notice emails.
##
## The two scripts are mutually exclusive - you should load one or the other,
## but not both.
...
export {
	redef enum Notice::Type += {
		...
		## detected.
		SQL_Injection_Attacker &deprecated="switch to using improved script detect-sql-injection",
