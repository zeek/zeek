...
public:
	...
	[[deprecated("Remove in v4.1.  Use MakeHashKey().")]] HashKey*
	ComputeHash(const Val* v, bool type_check) const
		{
	...
	[[deprecated("Remove in v4.1.  Pass in HashKey& instead.")]] ListValPtr
	RecoverVals(const HashKey* k) const
		{
...
using CompositeHash [[deprecated("Remove in v4.1. Use zeek::detail::CompositeHash.")]] =
	zeek::detail::CompositeHash;
