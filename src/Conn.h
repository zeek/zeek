...
class Connection final : public Obj
	{
public:
	[[deprecated("Remove in v4.1. Store encapsulation in the packet and use the other version of "
	             "the constructor instead.")]] Connection(NetSessions* s,
	                                                      const detail::ConnIDKey& k, double t,
	                                                      const ConnID* id, uint32_t flow,
	                                                      const Packet* pkt,
	...
	[[deprecated("Remove in v4.1.  Use EnqueueEvent() instead (note it doesn't automatically add "
	             "the connection argument).")]] void
	Event(EventHandlerPtr f, analyzer::Analyzer* analyzer, Val* v1, Val* v2 = nullptr);
	...
	[[deprecated("Remove in v4.1.  Use EnqueueEvent() instead.")]] void
	ConnectionEvent(EventHandlerPtr f, analyzer::Analyzer* analyzer, ValPList vl);
	...
	[[deprecated("Remove in v4.1.  Use EnqueueEvent() instead.")]] void
	ConnectionEventFast(zeek::EventHandlerPtr f, zeek::analyzer::Analyzer* analyzer, ValPList vl);
...
protected:
	...
	// otherwise not.
	void AddTimer(timer_func timer, double t, bool do_expire, detail::TimerType type);
...
class ConnectionTimer final : public Timer
	{
public:
	ConnectionTimer(Connection* arg_conn, timer_func arg_timer, double arg_t, bool arg_do_expire,
	                TimerType arg_type)
...
using ConnEventToFlag [[deprecated("Remove in v4.1. Use zeek::ConnEventToFlag.")]] =
	zeek::ConnEventToFlag;
constexpr auto NUL_IN_LINE [[deprecated("Remove in v4.1. Use zeek::NUL_IN_LINE.")]] =
	zeek::NUL_IN_LINE;
constexpr auto SINGULAR_CR [[deprecated("Remove in v4.1. Use zeek::SINGULAR_CR.")]] =
	zeek::SINGULAR_CR;
constexpr auto SINGULAR_LF [[deprecated("Remove in v4.1. Use zeek::SINGULAR_LF.")]] =
	zeek::SINGULAR_LF;
constexpr auto NUM_EVENTS_TO_FLAG [[deprecated("Remove in v4.1. Use zeek::NUM_EVENTS_TO_FLAG.")]] =
	zeek::NUM_EVENTS_TO_FLAG;
...
using ConnectionTimer [[deprecated("Remove in v4.1. Use zeek::detail::ConnectionTimer.")]] =
	zeek::detail::ConnectionTimer;
