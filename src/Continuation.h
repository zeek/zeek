#warning                                                                                           \
	"This file will be removed in v4.1. The code here is unused by Zeek. Notify a Zeek team member if your plugins are using this code."
...
public:
	...
	void SaveState(void* user_ptr) { states.replace(current_level, user_ptr); }
