	...
	{
		{
			...
			{
			DebugCmdInfo* info;
			const char* const names[] = {"continue"};
			...
			{
			DebugCmdInfo* info;
			const char* const names[] = {"disable"};
			...
			{
			DebugCmdInfo* info;
			const char* const names[] = {"backtrace", "bt"};
