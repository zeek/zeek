...
public:
    ...
    auto FileName() const { return filename; }
    auto FirstLine() const { return first_line; }
    auto LastLine() const { return last_line; }

    std::string FileAndLine() const { return std::string(filename) + ":" + std::to_string(first_line); }
    std::string FileAndLastLine() const { return std::string(filename) + ":" + std::to_string(last_line); }
    std::string FileAndLines() const {
        return std::string(filename) + ":" + std::to_string(first_line) + "-" + std::to_string(last_line);
    }
