...
using PQ_Element [[deprecated("Remove in v4.1. Use zeek::detail::PQ_Element.")]] =
	zeek::detail::PQ_Element;
using PriorityQueue [[deprecated("Remove in v4.1. Use zeek::detail::PriorityQueue.")]] =
	zeek::detail::PriorityQueue;
