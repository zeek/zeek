...
public:
	...
	// Consume a chunk of data. data and len will be adjustes
	// accordingly. Returns true if we "exptected" bytes have been
	// processed, i.e., returns true when we don't expect any more data.
