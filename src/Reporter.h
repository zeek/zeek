...
using ReporterException [[deprecated("Remove in v4.1. Use zeek::ReporterException.")]] =
	zeek::ReporterException;
using InterpreterException [[deprecated("Remove in v4.1. Use zeek::InterpreterException.")]] =
