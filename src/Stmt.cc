...
void WhenInfo::Build(StmtPtr ws) {
    ...
    true_const->SetLocation(cond);
    param->SetLocation(cond);
    one_test->SetLocation(cond);
    two_test->SetLocation(cond);
    empty->SetLocation(cond);
    test_cond->SetLocation(cond);
    do_test->SetLocation(cond);
    else_branch->SetLocation(cond);
    do_bodies->SetLocation(cond);
    dummy_return->SetLocation(cond);
    shebang->SetLocation(cond);
    lambda->SetLocation(cond);
...
void WhenInfo::BuildInvokeElems() {
    ...
    one_const->SetLocation(cond);
    two_const->SetLocation(cond);
    three_const->SetLocation(cond);
    invoke_cond->SetLocation(cond);
    invoke_s->SetLocation(cond);
    invoke_timeout->SetLocation(cond);
}
