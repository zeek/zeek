            ...
            loop_over_list(exprs, j) {
                if ( ! exprs[j]->IsConst() ) {
                    ...
                    switch ( expr->Tag() ) {
                        ...
                        case EXPR_NEGATE: {
                            NegExpr* ne = dynamic_cast<NegExpr*>(expr);
                        ...
                        case EXPR_POSITIVE: {
                            PosExpr* pe = dynamic_cast<PosExpr*>(expr);
                        ...
                        case EXPR_NAME: {
                            NameExpr* ne = dynamic_cast<NameExpr*>(expr);
