...
#include "syslog-tcp_pac.h"


class Syslog_UDP_Analyzer_binpac : public Analyzer {
public:
	Syslog_UDP_Analyzer_binpac(Connection* conn);
	virtual ~Syslog_UDP_Analyzer_binpac();
	...
	static Analyzer* InstantiateAnalyzer(Connection* conn)
		{ return new Syslog_UDP_Analyzer_binpac(conn); }

	static bool Available()
		{ return syslog_message && 1; }
...
protected:
	binpac::Syslog_TCP::Syslog_TCP_Conn* interp;
};
