...
void RecordVal::AssignCallback(int field, detail::ZValCallback* cb) {
    const auto* rt = GetRecordType();
...
TEST_CASE("assign callback to record val") {
    ...
    class MyCallback : public zeek::detail::ZValCallback {
    public:
        MyCallback() {}
        zeek::ZVal operator()(const zeek::ZVal& record_val, const zeek::ZVal& field) const override {
