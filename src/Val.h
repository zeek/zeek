...
#define UNDERLYING_ACCESSOR_DECL(ztype, ctype, name) ctype name() const;
    ...
    // The version of the data generated by ToJSON and read by ValFromJSON. If that
    // structure changes, this number must be increased.
    static const int JSON_VERSION = 1;
