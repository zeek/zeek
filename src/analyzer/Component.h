...
public:
     ...
     * or TRANSPORT_UNKNOWN if it handles any. Used to keep an analyzer
     * replacement from claiming ports of a transport it can't handle.
     */
    ...
    /**
     * Returns the transport-layer protocol the analyzer expects, or
     * TRANSPORT_UNKNOWN if it handles any.
     */
...
private:
    ...
    TransportProto transport; // Transport the analyzer expects, or TRANSPORT_UNKNOWN for any.
};
