...
public:
	...
	static analyzer::Analyzer* Instantiate(Connection* conn) { return new DHCP_Analyzer(conn); }
...
using DHCP_Analyzer [[deprecated("Remove in v4.1. Use zeek::analyzer::dhcp::DHCP_Analyzer.")]] =
	zeek::analyzer::dhcp::DHCP_Analyzer;
