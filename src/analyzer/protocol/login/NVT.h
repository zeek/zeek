...
using TelnetOption [[deprecated("Remove in v4.1. Use zeek::analyzer::login::TelnetOption.")]] =
	zeek::analyzer::login::TelnetOption;
using TelnetTerminalOption
	[[deprecated("Remove in v4.1. Use zeek::analyzer::login::detail::TelnetTerminalOption.")]] =
		zeek::analyzer::login::detail::TelnetTerminalOption;
using TelnetEncryptOption
	[[deprecated("Remove in v4.1. Use zeek::analyzer::login::detail::TelnetEncryptOption.")]] =
		zeek::analyzer::login::detail::TelnetEncryptOption;
using TelnetAuthenticateOption
	[[deprecated("Remove in v4.1. Use zeek::analyzer::login::detail::TelnetAuthenticateOption.")]] =
		zeek::analyzer::login::detail::TelnetAuthenticateOption;
using TelnetEnvironmentOption
...
using TelnetBinaryOption
	[[deprecated("Remove in v4.1. Use zeek::analyzer::login::detail::TelnetBinaryOption.")]] =
		zeek::analyzer::login::detail::TelnetBinaryOption;
using NVT_Analyzer [[deprecated("Remove in v4.1. Use zeek::analyzer::login::NVT_Analyzer.")]] =
	zeek::analyzer::login::NVT_Analyzer;
