refine connection SMB_Conn += {
	...
	function proc_smb2_session_setup_request(h: SMB2_Header, val: SMB2_session_setup_request): bool
		...
		if ( smb2_session_setup_request )
			{
			auto req = zeek::make_intrusive<RecordVal>(zeek::BifType::Record::SMB2::SessionSetupRequest);
	...
	function proc_smb2_session_setup_response(h: SMB2_Header, val: SMB2_session_setup_response): bool
		...
		if ( smb2_session_setup_response )
			{
			auto flags = zeek::make_intrusive<RecordVal>(zeek::BifType::Record::SMB2::SessionSetupFlags);
			...
			auto resp = zeek::make_intrusive<RecordVal>(zeek::BifType::Record::SMB2::SessionSetupResponse);
