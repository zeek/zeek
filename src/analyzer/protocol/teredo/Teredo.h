...
using Teredo_Analyzer
	[[deprecated("Remove in v4.1. Use zeek::analyzer::teredo::Teredo_Analyzer.")]] =
		zeek::analyzer::teredo::Teredo_Analyzer;
using TeredoEncapsulation
	[[deprecated("Remove in v4.1. Use zeek::analyzer::teredo::detail::TeredoEncapsulation.")]] =
		zeek::analyzer::teredo::detail::TeredoEncapsulation;
