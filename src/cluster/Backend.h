...
public:
     ...
     * Process an error.
     *
     * @param code A stringified structured error code not further specified.
     * @param message A free form message with more context.
     */
    void ProcessError(std::string_view code, std::string_view message) { return DoProcessError(code, message); };
...
private:
     ...
     * @param message A free form message with more context.
     */
    virtual void DoProcessError(std::string_view code, std::string_view message) = 0;
};
...
protected:
     ...
     * @param message A free form message with more context.
     */
    void ProcessError(std::string_view code, std::string_view message);
