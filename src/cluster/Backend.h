...
public:
    ...
    void SetTelemetry(detail::TelemetryPtr new_telemetry) {
        // Should we inject this through the constructor instead?
        telemetry = std::move(new_telemetry);
    }
...
protected:
     ...
     */
    detail::Telemetry& Telemetry() const { return *telemetry; }
