...
public:
     ...
     */
    virtual bool SerializeEvent(util::byte_buffer& buf, const detail::Event& event) = 0;
     ...
     */
    virtual std::optional<cluster::detail::Event> UnserializeEvent(util::byte_buffer_span buf) = 0;
...
public:
     ...
     */
    virtual bool SerializeLogWrite(util::byte_buffer& buf, const logging::detail::LogWriteHeader& header,
     ...
     */
    virtual std::optional<logging::detail::LogWriteBatch> UnserializeLogWrite(util::byte_buffer_span buf) = 0;
