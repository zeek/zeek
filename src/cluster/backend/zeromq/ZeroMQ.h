...
private:
    ...
    bool DoPublishEvent(const std::string& topic, const std::string& format, const util::byte_buffer& buf) override;
    ...
    bool DoPublishLogWrites(const logging::detail::LogWriteHeader& header, const std::string& format,
                            util::byte_buffer& buf) override;

    bool DoProcessBackendMessage(int tag, util::byte_buffer_span payload) override;
