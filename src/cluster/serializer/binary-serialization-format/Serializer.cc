...
bool detail::BinarySerializationFormatLogSerializer::SerializeLogWrite(util::byte_buffer& buf,
...
TEST_CASE("roundtrip") {
    ...
    zeek::util::byte_buffer expected{p, p + sizeof(expected_bytes)};
