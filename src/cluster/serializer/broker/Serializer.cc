...
bool detail::BrokerBinV1_Serializer::SerializeEvent(util::byte_buffer& buf, const detail::Event& event) {
...
std::optional<detail::Event> detail::BrokerBinV1_Serializer::UnserializeEvent(util::byte_buffer_span buf) {
...
bool detail::BrokerJsonV1_Serializer::SerializeEvent(util::byte_buffer& buf, const detail::Event& event) {
    auto ev = to_broker_event(event);
    if ( ! ev )
        return false;
...
std::optional<detail::Event> detail::BrokerJsonV1_Serializer::UnserializeEvent(util::byte_buffer_span buf) {
    broker::variant res;
    auto err =
