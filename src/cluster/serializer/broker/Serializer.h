...
public:
    ...
    bool SerializeEvent(util::byte_buffer& buf, const detail::Event& event) override;

    std::optional<detail::Event> UnserializeEvent(util::byte_buffer_span buf) override;
};
