...
protected:
	 ...
	 */
	shared_ptr<::binpac::declaration::Function> CreatePac2ItemAccessor(Pac2EventInfo* ev, int nr, const string& expr, shared_ptr<binpac::type::unit::Item> item);

	/**
	 * Create a HILTI prototype for the BinPAC++ generated by
	 * CreatePac2ItemAccessor().
	 */
	shared_ptr<::hilti::declaration::Function> DeclareHiltiItemAccessor(Pac2EventInfo* ev, int nr, const string& expr, shared_ptr<binpac::type::unit::Item> item);
