...
// Raise everything in here as warnings so it is passed to scriptlang without looking "fatal".
// In addition to these warnings, ReaderBackend will queue one reporter message.
