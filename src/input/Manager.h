...
protected:
	...
	// Signal Informational messages, warnings and errors. These will be passed to the error function in scriptland.
	// Note that the messages are not passed to reporter - this is done in ReaderBackend.
...
private:
	...
	// Check if the types of the error_ev event are correct.
	// if table is true, check for tablestream type, otherwhise check for eventstream type.
