...
public:
	...
	[[deprecated("Remove in v4.1.  Use GetTagType() instead.")]] EnumType* GetTagEnumType() const;
	...
	[[deprecated("Remove in v4.1.  Use IntrusivePtr argument instead.")]] const std::string&
	GetComponentName(Val* val) const;
...
template <class T, class C> EnumType* ComponentManager<T, C>::GetTagEnumType() const
	{
