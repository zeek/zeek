...
public:
    ...
    bool IsAlternative() const { return is_alt; }
    void SetAlternative() { is_alt = true; }
...
protected:
    ...
    // Whether this object corresponds to an "alternative" function body
    // created by coalescing event handlers.
    bool is_alt = false;
};
