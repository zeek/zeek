...
bool BuiltIn_Analyzer__name(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_Broker__flush_logs(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_Files__enable_reassembly(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_Files__set_reassembly_buffer(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_Log__write(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_cat(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_current_time(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_get_port_etc(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_is_v4_addr(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
bool BuiltIn_is_v6_addr(const NameExpr* n, int nslot, int arg0_slot, const ExprPList& args);
