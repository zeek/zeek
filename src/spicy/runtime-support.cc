...
ValPtr rt::detail::to_val(const hilti::rt::type_info::Value& value, const TypePtr& target) {
    ...
    switch ( type.tag ) {
        ...
        case TypeInfo::Bytes: {
            ...
            auto b = type.bytes->get(value);
            return make_intrusive<StringVal>(b.size(), b.data());
        }
        ...
        case TypeInfo::Optional: {
            auto x = type.optional->value(value);
        ...
        case TypeInfo::Set: {
            ...
            for ( auto i : type.set->iterate(value) ) {
                if ( tt->GetIndexTypes().size() != 1 )
                    throw ParameterMismatch(type, target);
        ...
        case TypeInfo::String: {
            ...
            auto s = type.string->get(value);
            return make_intrusive<StringVal>(s.size(), s.data());
        }

        case TypeInfo::StrongReference: {
            auto x = type.strong_reference->value(value);
            return x ? detail::to_val(x, target) : nullptr;
        }
        ...
        case TypeInfo::ValueReference: {
            auto x = type.value_reference->value(value);
            return x ? detail::to_val(x, target) : nullptr;
        }
        ...
        case TypeInfo::Vector: {
            ...
            for ( auto i : type.vector->iterate(value) )
        ...
        case TypeInfo::WeakReference: {
            auto x = type.weak_reference->value(value);
            return x ? detail::to_val(x, target) : nullptr;
        }
