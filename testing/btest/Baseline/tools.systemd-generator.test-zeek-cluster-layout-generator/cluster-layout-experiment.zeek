...
redef Cluster::nodes += {
    ["proxy-1"] = [$node_type=Cluster::PROXY, $ip=127.0.0.1, $p=27760/tcp, $metrics_port=9991/tcp],
    ["proxy-2"] = [$node_type=Cluster::PROXY, $ip=127.0.0.1, $p=27761/tcp, $metrics_port=9992/tcp],
    ["worker-1"] = [$node_type=Cluster::WORKER, $ip=127.0.0.1, $metrics_port=9993/tcp],
    ["worker-2"] = [$node_type=Cluster::WORKER, $ip=127.0.0.1, $metrics_port=9994/tcp],
};
