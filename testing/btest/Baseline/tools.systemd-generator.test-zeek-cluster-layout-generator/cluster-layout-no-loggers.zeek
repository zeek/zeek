...
redef Cluster::nodes += {
    ...
    ["proxy-1"] = [$node_type=Cluster::PROXY, $ip=127.0.0.1, $p=27761/tcp, $manager="manager", $metrics_port=9992/tcp],
    ["proxy-2"] = [$node_type=Cluster::PROXY, $ip=127.0.0.1, $p=27762/tcp, $manager="manager", $metrics_port=9993/tcp],
