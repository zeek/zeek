...
EventArg = Union[str, int, TaggedArg]
...
def build_event_arg_v1(arg: EventArg):
    ...
    This only supports `str`, `int` and `TaggedArg` arguments.
    """
...
def build_event_v1(
    ...
    """
    Build an event for testing using the qurky v1 format.
...
def main(f: Callable, *args, **kwargs):
    ...
    the assumption that the WebSocket wasn't yet available.
    """
