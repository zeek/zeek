# @TEST-DOC: Disabling an unrelated event group caused auto-publish to break because the remote even had no bodies and got disabled. This is a regression so I'm not doing that again..
#
# @TEST-GROUP: broker
#
