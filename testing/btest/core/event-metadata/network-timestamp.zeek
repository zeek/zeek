...
#
# @TEST-EXEC: zeek -r $TRACES/http/get.pcap %INPUT EventMetadata::add_network_timestamp=T > with_ts.out
# @TEST-EXEC: zeek -r $TRACES/http/get.pcap %INPUT EventMetadata::add_network_timestamp=F > without_ts.out
#
