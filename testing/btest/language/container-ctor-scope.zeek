...
global gl1: list of port = list( 1/tcp, 2/tcp, 3/tcp, 1/tcp );
...
global gl2: list of port = { 1/tcp, 2/tcp, 3/tcp, 1/tcp };
...
local l1: list of port = list( 1/tcp, 2/tcp, 3/tcp, 1/tcp );
...
local l2: list of port = { 1/tcp, 2/tcp, 3/tcp, 1/tcp };
