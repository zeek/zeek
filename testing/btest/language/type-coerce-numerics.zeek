...
# @TEST-EXEC: btest-diff-remove-abspath first_set.out
# @TEST-EXEC: btest-diff-remove-abspath first_set.err

# @TEST-EXEC-FAIL: zeek -b double_convert_failure1.zeek >double_convert_failure1.out 2>double_convert_failure1.err
# @TEST-EXEC: btest-diff-remove-abspath double_convert_failure1.out
# @TEST-EXEC: btest-diff-remove-abspath double_convert_failure1.err

# @TEST-EXEC-FAIL: zeek -b double_convert_failure2.zeek >double_convert_failure2.out 2>double_convert_failure2.err
# @TEST-EXEC: btest-diff-remove-abspath double_convert_failure2.out
# @TEST-EXEC: btest-diff-remove-abspath double_convert_failure2.err

# @TEST-EXEC-FAIL: zeek -b int_convert_failure.zeek >int_convert_failure.out 2>int_convert_failure.err
# @TEST-EXEC: btest-diff-remove-abspath int_convert_failure.out
# @TEST-EXEC: btest-diff-remove-abspath int_convert_failure.err

# @TEST-EXEC: zeek -b vectors.zeek >vectors.out 2>vectors.err
# @TEST-EXEC: btest-diff-remove-abspath vectors.out
# @TEST-EXEC: btest-diff-remove-abspath vectors.err
