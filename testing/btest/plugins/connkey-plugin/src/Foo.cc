...
public:
    ...
    void DoPopulateConnIdVal(const zeek::RecordValPtr& rv) override {
...
zeek::expected<zeek::ConnKeyPtr, std::string> FooFactory::DoConnKeyFromVal(const zeek::ValPtr& v) const {
