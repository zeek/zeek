...
event zeek_init() {
	...
	local res = Storage::Sync::open_backend(Storage::STORAGEDUMMY, Storage::JSON, opts, string, string);
	...
	res = Storage::Sync::open_backend(Storage::STORAGEDUMMY, Storage::JSON, opts, string, string);
