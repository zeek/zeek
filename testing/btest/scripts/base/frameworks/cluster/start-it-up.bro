...
redef Cluster::nodes = {
	...
	["proxy-1"] = [$node_type=Cluster::DATANODE,     $ip=127.0.0.1, $p=37758/tcp, $manager="manager-1", $workers=set("worker-1")],
	...
	["worker-2"] = [$node_type=Cluster::WORKER,   $ip=127.0.0.1, $p=37761/tcp, $manager="manager-1", $datanode="proxy-2", $interface="eth1"],
};
@TEST-END-FILE
