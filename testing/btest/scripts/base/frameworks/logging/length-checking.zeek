...
redef Log::limit_field_string_bytes = 0;
redef Log::limit_total_string_bytes = 0;
redef Log::limit_field_container_elements = 0;
redef Log::limit_total_container_elements = 0;
