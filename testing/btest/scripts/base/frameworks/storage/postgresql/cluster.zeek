# @TEST-DOC: Tests PostgreSQL storage in a cluster environment
...
global postgresql_data_written: event() &is_used;
...
event postgresql_data_written()
	{
	print "postgresql_data_written";
...
event postgresql_data_written()
	{
	local e = Cluster::make_event(postgresql_data_written);
