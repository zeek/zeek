# @TEST-DOC: When Content-Length has leading zeros, report a weird (Zeek discards them).
#
# @TEST-EXEC: zeek -b -r $TRACES/http/261/variant-08-leading_zeros.pcap %INPUT
#
