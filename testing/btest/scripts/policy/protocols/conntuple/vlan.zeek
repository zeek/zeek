...
# @TEST-EXEC: zeek-cut -m ts uid id.orig_h id.orig_p id.resp_h id.resp_p id.vlan id.inner_vlan service <conn.log >conn.log.cut
...
redef ConnTuple::factory = ConnTuple::CONNTUPLE_VLAN;
