...
redef Cluster::nodes = {
	...
	["proxy-1"] = [$node_type=Cluster::DATANODE,     $ip=127.0.0.1, $p=37758/tcp, $manager="manager-1", $workers=set("worker-1", "worker-2")],
	["proxy-2"] = [$node_type=Cluster::DATANODE,     $ip=127.0.0.1, $p=37759/tcp, $manager="manager-1", $workers=set("worker-2")],
	["worker-1"] = [$node_type=Cluster::WORKER,   $ip=127.0.0.1, $p=37760/tcp, $manager="manager-1", $datanode="proxy-1", $interface="eth0"],
	["worker-2"] = [$node_type=Cluster::WORKER,   $ip=127.0.0.1, $p=37761/tcp, $manager="manager-1", $datanode="proxy-1", $interface="eth1"],
};
@TEST-END-FILE
