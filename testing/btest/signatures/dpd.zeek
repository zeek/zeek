# @TEST-EXEC: zeek -b -s myftp -r $TRACES/ftp/ipv4.pcap %INPUT >dpd-ipv4.out
# @TEST-EXEC: zeek -b -s myftp -r $TRACES/ftp/ipv6.pcap %INPUT >dpd-ipv6.out
# @TEST-EXEC: zeek -b -r $TRACES/ftp/ipv4.pcap %INPUT >nosig-ipv4.out
# @TEST-EXEC: zeek -b -r $TRACES/ftp/ipv6.pcap %INPUT >nosig-ipv6.out
