...
# @TEST-EXEC: btest-diff-remove-abspath ./dir1/zeek-worker-eth2@.service
# @TEST-EXEC: btest-diff-remove-abspath ./dir1/zeek-worker-eth2@1.service.d/*conf
# @TEST-EXEC: btest-diff-remove-abspath ./dir1/zeek-worker-eth2@2.service.d/*conf
# @TEST-EXEC: btest-diff-remove-abspath ./dir1/zeek-worker-eth2@3.service.d/*conf
# @TEST-EXEC: btest-diff-remove-abspath ./dir1/zeek-worker-eth2@4.service.d/*conf
#
