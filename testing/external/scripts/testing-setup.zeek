...
# policy scripts for a cluster backends. Redefine back to Cluster::CLUSTER_BACKEND_NONE
# in order to skip initialize of cluster backend. Cluster backends may keep
